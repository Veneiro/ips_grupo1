...
public class PacienteControlador {
	...
	public void initialize(CitaDto cita, String nombrePaciente) {
		...
		vista_cita.getBtnProcedimientos().addActionListener(e -> SwingUtil
				.exceptionWrapper(() -> inicializarListaProcedimientos()));
		vista_cita.getBtnEdo().addActionListener(e -> SwingUtil
				.exceptionWrapper(() -> new EDOControlador(cita)));
	...
	private void inicializarListaProcedimientos() {
		ListaProcedimientosControlador lpc = new ListaProcedimientosControlador(
				cita);
		lpc.inicializar();
	}
