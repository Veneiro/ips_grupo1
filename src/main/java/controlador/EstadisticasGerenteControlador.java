...
public class EstadisticasGerenteControlador {
	...
	private void inicializarVistaEstadisticasGerente() {
		RegistroModelo.addRegistro(new RegistroDto("Gerente", "Consulta estadísticas"));
		egv.setVisible(true);
	...
	private void calcularEstadisticas() {
		if (!egv.getTextDesde().getText().isEmpty() && !egv.getTextHasta().getText().isEmpty()) {
			...
			String header[] = new String[] { "Nombre", "Enfermedad", "Numero de pacientes con la enfermedad" };
