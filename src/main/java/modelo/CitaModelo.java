...
public class CitaModelo {
	...
	public void addCita(CitaDto cita) {
		String sql = "INSERT INTO TCITAS (id,horario_inicio,horario_fin,ubicacion,id_paciente,id_medico,acudio,fecha,informacion,especialidad, hora_entrada, hora_salida, nombre_paciente)"
				+ " VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?, ?, ?, ?)";
