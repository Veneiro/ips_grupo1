...
public class JornadaModelo {
    ...
    public List<JornadaLaboralRecord> findByName(int idTrabajador) {
	String sql = "SELECT * FROM TJORNADALABORAL WHERE ID_TRABAJADOR LIKE ?";

	return db.executeQueryPojo(JornadaLaboralRecord.class, sql, "%" + idTrabajador + "%");
    }
