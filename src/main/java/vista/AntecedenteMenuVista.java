...
@Getter
public class AntecedenteMenuVista extends JDialog {
	...
	public AntecedenteMenuVista() {
		...
		btnModificar = new JButton("Modificar Antecedente");
		btnModificar.setBounds(10, 40, 166, 21);
		getContentPane().add(btnModificar);
		
		btnNueva = new JButton("Nueva Antecedente");
