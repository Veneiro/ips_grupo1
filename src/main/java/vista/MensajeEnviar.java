...
public class MensajeEnviar extends JDialog {
	...
	public JButton getBtnAdjunto() {
		if (btnAdjunto == null) {
			btnAdjunto = new JButton("Adjuntar Archivo");
	...
	private JPanel getPanel() {
		if (panel == null) {
			...
			panel.add(getPanel_29(), BorderLayout.WEST);
			panel.add(getPanel_30(), BorderLayout.EAST);
			panel.add(getPanel_43(), BorderLayout.SOUTH);
	...
	private JPanel getPanel_2() {
		if (panel_2 == null) {
			...
			panel_2.add(getPanel_44(), BorderLayout.SOUTH);
			panel_2.add(getPanel_45(), BorderLayout.WEST);
			panel_2.add(getPanel_46(), BorderLayout.EAST);
			panel_2.add(getBtnAdjunto(), BorderLayout.CENTER);
		}
		return panel_2;
	}
